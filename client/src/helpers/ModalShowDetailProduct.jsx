          ...
          <div className="col-md-6 col-xl-4 p-3" key={product.id + "@"}>
            <Card className="my-detail-card">
              ...
              <Card.Body>
                ...
                <Card.Text className="price" style={{color:"#670000",fontWeight:"700"}}>Price: {product.price}₹</Card.Text>
                <Card.Text className="price" style={{color:"red",fontWeight:"700"}}>Weight: {product.weight}</Card.Text>
